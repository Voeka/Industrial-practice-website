...
<html lang="ru">
  ...
  <header>
    ...
    <section>
        ...
        <div class="card">
            <div class="card-header">
              Номер заказа: <?php print_r($order['id']); ?><br>
              Id-User: <?php print_r($order['id_user']); ?>
            </div>
            <div class="card-body">
              ...
              <br>
                <footer class="blockquote-footer"><form action="change_order.php" method="post">
                    <input type="hidden" name="id" value=" <?php print_r($order['id']); ?>">
                    <input type="checkbox" name="chek" id="" require>
                    <input type="text" name="status" id=""  value='<?php print_r($order['status']); ?>'>
    ...
    <form action="create.php" method="post">
                    <input type="text" name="name" placeholder='Название' id=""><br>
                    <textarea name="des" id="" cols="30" rows="5" placeholder='Описание'></textarea><br>
                    <input type="number" name="quanity" placeholder='Колличество' id=""><br>
                    <input type="number" name="price" placeholder='Цена' id=""><br>
                    <input type="text" name="img" placeholder='url-картинки' id=""><br>
