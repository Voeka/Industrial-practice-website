...
if(isset($_POST['delfromcart'])){
  unset($_SESSION['list'][$_POST['id-list']]);
}
        ...
        <div class="card">
            ...
            <div class="card-body">
              <blockquote class="blockquote mb-0">
                 <div class='book-x'>
                  <?php foreach($_SESSION['list'] as $key =>$item){  ?>
                    <div class="card" style="width: 18rem;">
                        <img src="<?php print_r($item['img']); ?>" class="card-img-top" alt="...">
                        <div class="card-body">
                        <a href="item.php?id=<?php print_r($item['id']); ?>">  <h5 class="card-title"><?php print_r($item['name']); ?></h5> </a>
                            <form method='post'>
                                <input type="hidden" name="delfromcart">
                                <input type="hidden" name="id-list" value='<?php print_r($key); ?>'>
          ...
          <a href="buy.php" class="btn btn-primary">Перейти к покупке</a>
    </section>
