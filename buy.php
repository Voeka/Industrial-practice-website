  ...
  <header>
    ...
    <section>
        ...
        <form action="action_buy.php" method="post">
            ...
            <input type="tel" name="tel" required id="">
            <p>Адрес куда</p>
            <input type="text" name="way-user" required id="">
            <p>Общая сумма товаров: <?php print_r($total); ?></p>
            <input type="hidden" name="sum" value='<?php print_r($total); ?>'>
            <input type="submit" value="Купить">
            <!-- Алерт о покупке и перевод в личный кабинет -->
        </form>
