...
<html lang="ru">
  ...
  <body>
    ...
    <section>
        <h1><?php print_r($items['name']);  ?></h1>
        <img src="<?php print_r($items['img']);  ?>" alt="">
        <br><br>
        <p><?php print_r($items['des']);  ?></p>
        <p><b>Цена: <?php print_r($items['price']);  ?></b></p>
        <form method='post'>
            <input type="hidden" name="gotocard" value='1'>
            <input type="hidden" name="id" value="<?php print_r($items['id']);  ?>">
